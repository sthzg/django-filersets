...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Affiliate.slug'
        db.add_column(u'filersets_affiliate', 'slug',
                      self.gf('autoslug.fields.AutoSlugField')(default='', unique_with=(), max_length=80, populate_from='label', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Affiliate.slug'
        db.delete_column(u'filersets_affiliate', 'slug')
