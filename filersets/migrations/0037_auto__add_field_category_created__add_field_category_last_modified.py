...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'filersets_category', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 10, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Category.last_modified'
        db.add_column(u'filersets_category', 'last_modified',
    ...
    def backwards(self, orm):
        ...
        db.delete_column(u'filersets_category', 'created')

        # Deleting field 'Category.last_modified'
        db.delete_column(u'filersets_category', 'last_modified')
    ...
    models = {
        ...
        u'filersets.set': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 13, 14, 32, 21)', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
