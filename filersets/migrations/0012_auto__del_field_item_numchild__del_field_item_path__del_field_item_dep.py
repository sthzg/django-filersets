...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'filersets_item', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)

        # Adding field 'Item.modified'
        db.add_column(u'filersets_item', 'modified',
                      self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        db.add_column(u'filersets_item', 'path',
                      self.gf('django.db.models.fields.CharField')(default=0, max_length=255, unique=True),
                      keep_default=False)
        ...
        db.delete_column(u'filersets_item', 'created')

        # Deleting field 'Item.modified'
        db.delete_column(u'filersets_item', 'modified')
