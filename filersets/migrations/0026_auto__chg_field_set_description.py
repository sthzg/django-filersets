...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Set.description'
        db.alter_column(u'filersets_set', 'description', self.gf('django.db.models.fields.TextField')(null=True))

    def backwards(self, orm):

        # Changing field 'Set.description'
        db.alter_column(u'filersets_set', 'description', self.gf('django.db.models.fields.TextField')(default=''))
