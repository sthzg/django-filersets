...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'FilemodelExt'
        db.create_table(u'filersets_filemodelext', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('filer_file', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='filemodelext_file', null=True, blank=True, to=orm['filer.File'])),
            ('is_timeline', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal(u'filersets', ['FilemodelExt'])


    def backwards(self, orm):
        # Deleting model 'FilemodelExt'
        db.delete_table(u'filersets_filemodelext')
