...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_column('filersets_settype_category', 'affiliate_id', 'settype_id')

    def backwards(self, orm):
        db.rename_column('filersets_settype_category', 'settype_id', 'affiliate_id')
    ...
    models = {
        ...
        u'filersets.set': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 24, 20, 35, 49, 6)', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
