...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Item.title_de'
        db.add_column(u'filersets_item', 'title_de',
                      self.gf('django.db.models.fields.CharField')(default=None, max_length=150, null=True, blank=True),
                      keep_default=False)
        ...
        # Adding field 'Item.description_de'
        db.add_column(u'filersets_item', 'description_de',
                      self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Item.title_de'
        db.delete_column(u'filersets_item', 'title_de')

        # Deleting field 'Item.description_en'
        db.delete_column(u'filersets_item', 'description_en')

        # Deleting field 'Item.description_de'
        db.delete_column(u'filersets_item', 'description_de')
