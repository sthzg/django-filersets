...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field category on 'Set'
        m2m_table_name = db.shorten_name(u'filersets_set_category')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('set', models.ForeignKey(orm[u'filersets.set'], null=False)),
            ('category', models.ForeignKey(orm[u'filersets.category'], null=False))
        ))
        db.create_unique(m2m_table_name, ['set_id', 'category_id'])
        ...
        db.create_table(u'filersets_item', (
            ...
            ('parent', self.gf('mptt.fields.TreeForeignKey')(blank=True, related_name='item_children', null=True, to=orm['filersets.Item'])),
            ('title', self.gf('django.db.models.fields.CharField')(default=None, max_length=150, null=True, blank=True)),
            ('title_en', self.gf('django.db.models.fields.CharField')(default=None, max_length=150, null=True, blank=True)),
            ('title_de', self.gf('django.db.models.fields.CharField')(default=None, max_length=150, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('description_en', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('description_de', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ...
        db.create_table(u'filersets_category', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ...
            ('name', self.gf('django.db.models.fields.CharField')(default=None, max_length=140)),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(default=None, unique_with=(), max_length=80, populate_from='name', blank=True)),
            ('slug_composed', self.gf('django.db.models.fields.CharField')(default=None, max_length=150, unique=True, null=True, blank=True)),
            ('description', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
            ('parent', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='cat_parent', null=True, blank=True, to=orm['filersets.Category'])),
        ))
        db.send_create_signal(u'filersets', ['Category'])
    ...
    def backwards(self, orm):
        ...
        # Removing M2M table for field category on 'Set'
        db.delete_table(db.shorten_name(u'filersets_set_category'))

        # Deleting model 'Item'
        db.delete_table(u'filersets_item')

        # Deleting model 'Category'
        db.delete_table(u'filersets_category')
    ...
    models = {
        ...
        u'filersets.item': {
            ...
            'parent': ('mptt.fields.TreeForeignKey', [], {'blank': 'True', 'related_name': "'item_children'", 'null': 'True', 'to': u"orm['filersets.Item']"}),
            u'rght': ('django.db.models.fields.PositiveIntegerField', [], {'db_index': 'True'}),
