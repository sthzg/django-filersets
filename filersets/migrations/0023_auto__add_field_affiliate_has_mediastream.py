...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Affiliate.has_mediastream'
        db.add_column(u'filersets_affiliate', 'has_mediastream',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Affiliate.has_mediastream'
        db.delete_column(u'filersets_affiliate', 'has_mediastream')
