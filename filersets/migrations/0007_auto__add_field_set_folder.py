...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Set.folder'
        db.add_column(u'filersets_set', 'folder',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['filer.Folder']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Set.folder'
        db.delete_column(u'filersets_set', 'folder_id')
