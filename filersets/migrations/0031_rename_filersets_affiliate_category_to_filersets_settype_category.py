...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        db.rename_table('filersets_affiliate_category', 'filersets_settype_category')

    def backwards(self, orm):
        db.rename_table('filersets_settype_category', 'filersets_affiliate_category')
    ...
    models = {
        ...
        u'filersets.set': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 24, 20, 27, 54, 6)', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
