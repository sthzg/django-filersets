...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'SetItemSort'
        db.create_table(u'filersets_setitemsort', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('item', self.gf('django.db.models.fields.related.OneToOneField')(default=None, related_name='item_sort', unique=True, to=orm['filersets.Item'])),
            ('set', self.gf('django.db.models.fields.related.ForeignKey')(default=None, related_name='set_sort', to=orm['filersets.Set'])),
            ('sort', self.gf('django.db.models.fields.PositiveIntegerField')(default=None, null=True)),
        ))
        db.send_create_signal(u'filersets', ['SetItemSort'])

        # Adding unique constraint on 'SetItemSort', fields ['item', 'set', 'sort']
        db.create_unique(u'filersets_setitemsort', ['item_id', 'set_id', 'sort'])


    def backwards(self, orm):
        # Removing unique constraint on 'SetItemSort', fields ['item', 'set', 'sort']
        db.delete_unique(u'filersets_setitemsort', ['item_id', 'set_id', 'sort'])

        # Deleting model 'SetItemSort'
        db.delete_table(u'filersets_setitemsort')
    ...
    models = {
        ...
        u'filersets.setitemsort': {
            'Meta': {'unique_together': "(('item', 'set', 'sort'),)", 'object_name': 'SetItemSort'},
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
