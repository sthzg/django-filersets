...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding M2M table for field category on 'FilemodelExt'
        m2m_table_name = db.shorten_name(u'filersets_filemodelext_category')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('filemodelext', models.ForeignKey(orm[u'filersets.filemodelext'], null=False)),
            ('category', models.ForeignKey(orm[u'filersets.category'], null=False))
        ))
        db.create_unique(m2m_table_name, ['filemodelext_id', 'category_id'])


    def backwards(self, orm):
        # Removing M2M table for field category on 'FilemodelExt'
        db.delete_table(db.shorten_name(u'filersets_filemodelext_category'))
