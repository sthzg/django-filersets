...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'FilemodelExt.id'
        db.delete_column(u'filersets_filemodelext', u'id')


        # Changing field 'FilemodelExt.filer_file'
        db.alter_column(u'filersets_filemodelext', 'filer_file_id', self.gf('django.db.models.fields.related.ForeignKey')(default=0, unique=True, primary_key=True, to=orm['filer.File']))
        # Deleting field 'Item.is_timeline'
        db.delete_column(u'filersets_item', 'is_timeline')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'FilemodelExt.id'
        raise RuntimeError("Cannot reverse this migration. 'FilemodelExt.id' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'FilemodelExt.id'
        db.add_column(u'filersets_filemodelext', u'id',
                      self.gf('django.db.models.fields.AutoField')(primary_key=True),
                      keep_default=False)


        # Changing field 'FilemodelExt.filer_file'
        db.alter_column(u'filersets_filemodelext', 'filer_file_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['filer.File'], unique=True))
        # Adding field 'Item.is_timeline'
        db.add_column(u'filersets_item', 'is_timeline',
    ...
    models = {
        ...
        u'filersets.filemodelext': {
            ...
            'filer_file': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'filemodelext_file'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['filer.File']"}),
