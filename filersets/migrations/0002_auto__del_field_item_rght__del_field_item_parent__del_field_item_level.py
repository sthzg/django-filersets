...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Item.rght'
        db.delete_column(u'filersets_item', u'rght')

        # Deleting field 'Item.parent'
        db.delete_column(u'filersets_item', 'parent_id')

        # Deleting field 'Item.level'
        db.delete_column(u'filersets_item', u'level')

        # Deleting field 'Item.order'
        db.delete_column(u'filersets_item', 'order')

        # Deleting field 'Item.lft'
        db.delete_column(u'filersets_item', u'lft')

        # Deleting field 'Item.tree_id'
        db.delete_column(u'filersets_item', u'tree_id')

        # Adding field 'Item.path'
        db.add_column(u'filersets_item', 'path',
                      self.gf('django.db.models.fields.CharField')(null=False, unique=True, max_length=255),
                      keep_default=False)

        # Adding field 'Item.depth'
        db.add_column(u'filersets_item', 'depth',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Item.numchild'
        db.add_column(u'filersets_item', 'numchild',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Item.rght'
        db.add_column(u'filersets_item', u'rght',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Item.parent'
        db.add_column(u'filersets_item', 'parent',
                      self.gf('mptt.fields.TreeForeignKey')(related_name='item_children', null=True, to=orm['filersets.Item'], blank=True),
                      keep_default=False)

        # Adding field 'Item.level'
        db.add_column(u'filersets_item', u'level',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Item.order'
        db.add_column(u'filersets_item', 'order',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0),
                      keep_default=False)

        # Adding field 'Item.lft'
        db.add_column(u'filersets_item', u'lft',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Adding field 'Item.tree_id'
        db.add_column(u'filersets_item', u'tree_id',
                      self.gf('django.db.models.fields.PositiveIntegerField')(default=0, db_index=True),
                      keep_default=False)

        # Deleting field 'Item.path'
        db.delete_column(u'filersets_item', 'path')

        # Deleting field 'Item.depth'
        db.delete_column(u'filersets_item', 'depth')

        # Deleting field 'Item.numchild'
        db.delete_column(u'filersets_item', 'numchild')
