...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Settype.template_conf'
        db.add_column(u'filersets_settype', 'template_conf',
                      self.gf('django.db.models.fields.CharField')(default=u'default', max_length=60, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Settype.template_conf'
        db.delete_column(u'filersets_settype', 'template_conf')
    ...
    models = {
        ...
        u'filersets.set': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 14, 13, 13, 30, 1)', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
