...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'FilemodelExt', fields ['filer_file']
        db.create_unique(u'filersets_filemodelext', ['filer_file_id'])


    def backwards(self, orm):
        # Removing unique constraint on 'FilemodelExt', fields ['filer_file']
        db.delete_unique(u'filersets_filemodelext', ['filer_file_id'])
    ...
    models = {
        ...
        u'filersets.filemodelext': {
            ...
            'filer_file': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'filemodelext_file'", 'null': 'True', 'default': 'None', 'to': "orm['filer.File']", 'blank': 'True', 'unique': 'True'}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
