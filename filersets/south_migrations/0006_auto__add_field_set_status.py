...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Set.status'
        db.add_column(u'filersets_set', 'status',
                      self.gf('django.db.models.fields.CharField')(default='unpublished', max_length=15, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Set.status'
        db.delete_column(u'filersets_set', 'status')
