...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Category.is_group'
        db.add_column(u'filersets_category', 'is_group',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Category.is_group'
        db.delete_column(u'filersets_category', 'is_group')
    ...
    models = {
        ...
        u'filersets.filemodelext': {
            ...
            'filer_file': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'filemodelext_file'", 'unique': 'True', 'primary_key': 'True', 'to': "orm['filer.File']"}),
        ...
        u'filersets.item': {
            ...
            'description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            'filer_file': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "u'filer_file_obj'", 'null': 'True', 'blank': 'True', 'to': "orm['filer.File']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'filersets.set': {
            ...
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2015, 6, 17, 12, 25, 42, 2)', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        u'filersets.settype': {
            ...
            'base_folder': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'to': "orm['filer.Folder']", 'null': 'True', 'blank': 'True'}),
