...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Set.ordering'
        db.add_column(u'filersets_set', 'ordering',
                      self.gf('django.db.models.fields.CharField')(default='original_filename', max_length=50, null=True, blank=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Set.ordering'
        db.delete_column(u'filersets_set', 'ordering')
