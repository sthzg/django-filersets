...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column(u'filersets_item', 'created', self.gf('model_utils.fields.AutoCreatedField')())

        # Changing field 'Item.modified'
        db.alter_column(u'filersets_item', 'modified', self.gf('model_utils.fields.AutoLastModifiedField')())
        # Adding field 'Settype.show_categories'
        db.add_column(u'filersets_settype', 'show_categories',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Settype.show_set_date'
        db.add_column(u'filersets_settype', 'show_set_date',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)

        # Adding field 'Settype.show_description'
        db.add_column(u'filersets_settype', 'show_description',
                      self.gf('django.db.models.fields.BooleanField')(default=True),
                      keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Item.created'
        db.alter_column(u'filersets_item', 'created', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Item.modified'
        db.alter_column(u'filersets_item', 'modified', self.gf('django.db.models.fields.DateTimeField')())
        # Deleting field 'Settype.show_categories'
        db.delete_column(u'filersets_settype', 'show_categories')

        # Deleting field 'Settype.show_set_date'
        db.delete_column(u'filersets_settype', 'show_set_date')

        # Deleting field 'Settype.show_description'
        db.delete_column(u'filersets_settype', 'show_description')
    ...
    models = {
        ...
        u'filersets.set': {
            ...
            'category': ('filersets.fields.TreeManyToManyField', [], {'related_name': "u'category_set'", 'default': 'None', 'to': u"orm['filersets.Category']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 21, 20, 22, 39, 1)', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
        ...
        u'filersets.settype': {
            ...
            'show_categories': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'show_description': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'show_set_date': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'slug': ('autoslug.fields.AutoSlugField', [], {'default': 'None', 'unique_with': '()', 'max_length': '80', 'populate_from': "u'label'", 'blank': 'True'}),
            'template_conf': ('django.db.models.fields.CharField', [], {'default': "u'default'", 'max_length': '60', 'blank': 'True'})
        }
    }
