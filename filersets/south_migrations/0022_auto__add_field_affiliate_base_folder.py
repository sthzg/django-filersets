...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Affiliate.base_folder'
        db.add_column(u'filersets_affiliate', 'base_folder',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['filer.Folder'], null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Affiliate.base_folder'
        db.delete_column(u'filersets_affiliate', 'base_folder_id')
