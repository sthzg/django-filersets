...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Settype.created'
        db.add_column(u'filersets_settype', 'created',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.datetime(2014, 10, 13, 0, 0), blank=True),
                      keep_default=False)

        # Adding field 'Settype.last_modified'
        db.add_column(u'filersets_settype', 'last_modified',
                      self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2014, 10, 13, 0, 0), blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Settype.created'
        db.delete_column(u'filersets_settype', 'created')

        # Deleting field 'Settype.last_modified'
        db.delete_column(u'filersets_settype', 'last_modified')
    ...
    models = {
        ...
        u'filersets.set': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 13, 14, 30, 58)', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
