...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_table(db.shorten_name(u'filersets_item_category'))


    def backwards(self, orm):
        # Adding M2M table for field category on 'Item'
        m2m_table_name = db.shorten_name(u'filersets_item_category')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('item', models.ForeignKey(orm[u'filersets.item'], null=False)),
