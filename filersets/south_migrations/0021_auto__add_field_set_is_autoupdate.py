...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Set.is_autoupdate'
        db.add_column(u'filersets_set', 'is_autoupdate',
                      self.gf('django.db.models.fields.BooleanField')(default=False),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Set.is_autoupdate'
        db.delete_column(u'filersets_set', 'is_autoupdate')
