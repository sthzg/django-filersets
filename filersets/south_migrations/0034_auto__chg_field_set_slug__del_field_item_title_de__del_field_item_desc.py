...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Set.slug'
        db.alter_column(u'filersets_set', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=80, populate_from=u'title'))

        # Changing field 'Settype.slug'
        db.alter_column(u'filersets_settype', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=80, populate_from=u'label'))

        # Changing field 'Category.slug'
        db.alter_column(u'filersets_category', 'slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=80, populate_from=u'name'))

    def backwards(self, orm):

        # Changing field 'Set.slug'
        db.alter_column(u'filersets_set', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=80, unique_with=(), populate_from='title'))

        # Changing field 'Settype.slug'
        db.alter_column(u'filersets_settype', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=80, unique_with=(), populate_from='label'))

        # Changing field 'Category.slug'
        db.alter_column(u'filersets_category', 'slug', self.gf('autoslug.fields.AutoSlugField')(max_length=80, unique_with=(), populate_from='name'))
    ...
    models = {
        ...
        u'filersets.set': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 10, 13, 13, 9, 49)', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
