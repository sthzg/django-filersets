...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'filersets_affiliate', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('label', self.gf('django.db.models.fields.CharField')(default=None, max_length=30)),
            ('namespace', self.gf('django.db.models.fields.CharField')(default=None, max_length=30, null=True, blank=True)),
            ('memo', self.gf('django.db.models.fields.TextField')(default=None, null=True, blank=True)),
        ))
        db.send_create_signal(u'filersets', ['Affiliate'])

        # Adding M2M table for field category on 'Affiliate'
        m2m_table_name = db.shorten_name(u'filersets_affiliate_category')
        db.create_table(m2m_table_name, (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('affiliate', models.ForeignKey(orm[u'filersets.affiliate'], null=False)),
            ('category', models.ForeignKey(orm[u'filersets.category'], null=False))
        ))
        db.create_unique(m2m_table_name, ['affiliate_id', 'category_id'])


    def backwards(self, orm):
        # Deleting model 'Affiliate'
        db.delete_table(u'filersets_affiliate')

        # Removing M2M table for field category on 'Affiliate'
        db.delete_table(db.shorten_name(u'filersets_affiliate_category'))
