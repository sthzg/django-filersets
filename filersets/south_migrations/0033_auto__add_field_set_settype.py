...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Set.settype'
        db.add_column(u'filersets_set', 'settype',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='settype_set', to=orm['filersets.Settype']),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Set.settype'
        db.delete_column(u'filersets_set', 'settype_id')
    ...
    models = {
        ...
        u'filersets.filemodelext': {
            ...
            'category': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'filemodelext_category'", 'default': 'None', 'to': u"orm['filersets.Category']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            'filer_file': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'filemodelext_file'", 'unique': 'True', 'primary_key': 'True', 'to': u"orm['filer.File']"}),
        ...
        u'filersets.item': {
            ...
            'filer_file': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'filer_file_obj'", 'null': 'True', 'blank': 'True', 'to': u"orm['filer.File']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        u'filersets.set': {
            ...
            'created': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now', 'blank': 'True'}),
            'date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2014, 8, 24, 22, 14, 15, 6)', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
            ...
            'settype': ('django.db.models.fields.related.ForeignKey', [], {'default': 'None', 'related_name': "'settype_set'", 'to': u"orm['filersets.Settype']"}),
        ...
        u'filersets.settype': {
            ...
            'category': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'settype_categories'", 'default': 'None', 'to': u"orm['filersets.Category']", 'blank': 'True', 'symmetrical': 'False', 'null': 'True'}),
            ...
            'slug': ('autoslug.fields.AutoSlugField', [], {'default': 'None', 'unique_with': '()', 'max_length': '80', 'populate_from': "'label'", 'blank': 'True'})
        }
    }
